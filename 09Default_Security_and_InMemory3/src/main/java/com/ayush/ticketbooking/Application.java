...
public class Application implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		ticketobj1.setPassangerName("Ayu");
		ticketobj1.setSourceStation("Odi");
		ticketobj1.setDestinationStation("Hyd");
		ticketobj1.setEmail("ayushkhuntialitu@gmail.com");
		ticketobj1.setTravelDate(new Date());;
		
		ticketService.createTicket(ticketobj1);
